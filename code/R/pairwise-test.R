...
fit.2 <- fit.rarebinaryCPP(beta.init = 0, xi.init = xi.t,
                           alpha.init = alpha.t,rho.init = rho.t,
                           xi.fix = TRUE, alpha.fix = FALSE, rho.fix = FALSE,
                           y = y, dw2 = dw2, d = d, cov = x,
                           alpha.min = 0, alpha.max = 1, threads = 6)

fit.5 <- fit.rarebinaryCPP(beta.init = 0, xi.init = xi.t,
                           alpha.init = alpha.t,rho.init = rho.t,
                           xi.fix = TRUE, alpha.fix = TRUE, rho.fix = FALSE,
                           y = y, dw2 = dw2, d = d, cov = x,
                           alpha.min = 0, alpha.max = 1, threads = 6)

fit.6 <- fit.rarebinaryCPP(beta.init = 0, xi.init = xi.t,
                           alpha.init = alpha.t,rho.init = rho.t,
                           xi.fix = TRUE, alpha.fix = FALSE, rho.fix = TRUE,
                           y = y, dw2 = dw2, d = d, cov = x,
                           alpha.min = 0, alpha.max = 1, threads = 6)

fit.8 <- fit.rarebinaryCPP(beta.init = 0, xi.init = xi.t,
                           alpha.init = alpha.t,rho.init = rho.t,
                           xi.fix = TRUE, alpha.fix = TRUE, rho.fix = TRUE,
                           y = y, dw2 = dw2, d = d, cov = x,
                           alpha.min = 0, alpha.max = 1, threads = 6)
