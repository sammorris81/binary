...
fit.gev <- mcmc(y = y.o, s = s.o, x = X.o, s.pred = NULL, x.pred = NULL,
                beta.init = fit$par[4], beta.m = 0, beta.s = 10,
...
```{r gev1ters1-1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev$beta, type="l", main=bquote(beta[0]))
plot(fit.gev$xi, type="l", main=bquote(xi))
```

```{r gev1ters1-1-g1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g1$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g1$xi, type="l", main=bquote(xi))
```

```{r gev1ters1-1-g2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g2$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g2$xi, type="l", main=bquote(xi))
```

```{r gev1ters1-1-g3, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g3$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g3$xi, type="l", main=bquote(xi))
```
...
```{r gev1ters2-1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev$beta, type="l", main=bquote(beta[0]))
plot(fit.gev$xi, type="l", main=bquote(xi))
```

```{r gev1ters2-1-g1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g1$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g1$xi, type="l", main=bquote(xi))
```

```{r gev1ters2-1-g2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g2$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g2$xi, type="l", main=bquote(xi))
```

```{r gev1ters2-1-g3, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g3$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g3$xi, type="l", main=bquote(xi))
```
...
```{r gev1ters3-1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev$beta, type="l", main=bquote(beta[0]))
plot(fit.gev$xi, type="l", main=bquote(xi))
```

```{r gev1ters3-1-g1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g1$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g1$xi, type="l", main=bquote(xi))
```

```{r gev1ters3-1-g2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g2$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g2$xi, type="l", main=bquote(xi))
```

```{r gev1ters3-1-g3, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g3$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g3$xi, type="l", main=bquote(xi))
```
...
```{r gev1ters1-2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev$beta, type="l", main=bquote(beta[0]))
plot(fit.gev$xi, type="l", main=bquote(xi))
```

```{r gev1ters1-2-g1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g1$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g1$xi, type="l", main=bquote(xi))
```

```{r gev1ters1-2-g2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g2$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g2$xi, type="l", main=bquote(xi))
```

```{r gev1ters1-2-g3, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g3$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g3$xi, type="l", main=bquote(xi))
```
...
```{r gev1ters2-2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev$beta, type="l", main=bquote(beta[0]))
plot(fit.gev$xi, type="l", main=bquote(xi))
```

```{r gev1ters2-2-g1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g1$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g1$xi, type="l", main=bquote(xi))
```

```{r gev1ters2-2-g2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g2$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g2$xi, type="l", main=bquote(xi))
```

```{r gev1ters2-2-g3, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g3$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g3$xi, type="l", main=bquote(xi))
```
...
```{r gev1ters3-2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev$beta, type="l", main=bquote(beta[0]))
plot(fit.gev$xi, type="l", main=bquote(xi))
```

```{r gev1ters3-2-g1, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g1$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g1$xi, type="l", main=bquote(xi))
```

```{r gev1ters3-2-g2, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g2$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g2$xi, type="l", main=bquote(xi))
```

```{r gev1ters3-2-g3, echo=FALSE, fig.width=7, fig.height=3}
par(mfrow=c(1, 2))
plot(fit.gev.g3$beta, type="l", main=bquote(beta[0]))
plot(fit.gev.g3$xi, type="l", main=bquote(xi))
```
