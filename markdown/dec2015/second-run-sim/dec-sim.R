...
for (i in sets) {
  ...
  score <- matrix(NA, 3, 2)  # place to store brier scores and auc
  rownames(score) <- c("gev", "probit", "logit")
  colnames(score) <- c("bs", "auc")
