...
\tref{rbtbl:dataresults} give summary Brier scores ($\times 100$) and AUROC for the \tamarix{} and \hedysarum{} analysis.
...
\begin{table}
  \caption{Brier scores ($\times 100$) [SE] and AUROC [SE] for GEV, Probit, and Logistic methods for \emph{Tamarix ramosissima} and \emph{Hedysarum scoparium}.}
  \label{rbtbl:dataresults}
  \centering
  \scriptsize
  \begin{tabular}{c c c ccc c ccc}
  \toprule
    \multicolumn{3}{c}{ }& \multicolumn{3}{c}{BS} & \phantom{a} & \multicolumn{3}{c}{AUROC}\\
    \cmidrule{4-6} \cmidrule{8-10}
    Species & $n$ & Sample & GEV    & Probit & Logistic & \phantom{ab} & GEV    & Probit & Logistic \\
  \midrule
  TR & 100 & CLU & 5.120 [0.050] & 5.039 [0.049] & 5.382 [0.029] && 0.732 [0.014]
           & 0.731 [0.014] & 0.699 [0.012]\\
     &     & SRS & 4.997 [0.045] & 4.938 [0.055] & 5.500 [0.027] && 0.798 [0.008]
           & 0.802 [0.009] & 0.636 [0.012]\\
     & 250 & CLU & 4.779 [0.049] & 4.657 [0.045] & 4.950 [0.051] && 0.771 [0.013]
           & 0.784 [0.013] & 0.798 [0.011]\\
     &     & SRS & 4.823 [0.053] & 4.735 [0.048] & 5.120 [0.071] && 0.827 [0.011]
           & 0.851 [0.007] & 0.717 [0.019]\\
  \midrule
  HS & 100 & CLU & 1.765 [0.018] & 1.831 [0.029] & 1.679 [0.002] && 0.642 [0.010]
           & 0.617 [0.012] & 0.573 [0.008]\\
     &     & SRS & 1.914 [0.066] & 1.996 [0.083] & 1.685 [0.002] && 0.686 [0.009]
           & 0.683 [0.011] & 0.587 [0.008]\\
     & 250 & CLU & 1.667 [0.005] & 1.657 [0.006] & 1.679 [0.001] && 0.659 [0.009]
           & 0.648 [0.011] & 0.566 [0.005]\\
     &     & SRS & 1.691 [0.017] & 1.666 [0.010] & 1.684 [0.001] && 0.691 [0.010]
           & 0.709 [0.012] & 0.574 [0.007]\\
  \bottomrule
  \end{tabular}
\end{table}
