...
In the random effects model, the expression for the joint density conditional on $A_1, \ldots, A_L$ is
\begin{align}
...
Figures \ref{fig:post-med-2} and \ref{fig:post-med-3} show the posterior median of $P(Y =1)$ for settings 2 and 3 respectively.
